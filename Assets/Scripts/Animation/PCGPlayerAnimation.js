...
// Changed the ShootAddidative animation to only play the clip once rather than loop.
// This means the clip is played once each shot, rather than starting the 
// animation when shooting begins and just letting it run
function OnFireAgain() {
	animationComponent.Play(shootAdditive.name);
}
