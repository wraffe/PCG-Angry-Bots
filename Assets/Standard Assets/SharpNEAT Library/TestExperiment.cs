...
using SharpNeat.Domains;
     ...
     */
    class TestExperiment : INeatExperiment
    {
        ...
        public void Initialize(string name, XmlElement xmlConfig)
        {
            ...
            // Alternative is "Absolute", which means, with a threshold of 10, network wont ever be more complex than 10 (hidden nodes? layers? etc)
